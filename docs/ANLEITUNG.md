...
**Wie viel mitgeht:** Whisper beachtet nur rund 200 Wörter Kontext. WhisperLoom schickt deshalb zuerst die eigenen Begriffe, dann die aus der Datei, mit Komma verbunden und auf **800 Zeichen** gekappt — nie mitten in einem Begriff. Das Blatt sagt, was ankommt: „Alle n Begriffe werden mitgeschickt." bzw. „x von y Begriffen werden mitgeschickt: Whisper beachtet nur rund 200 Wörter Kontext. Eigene Begriffe haben Vorrang vor der Datei." Wichtige Namen gehören also in die eigene Liste oder an den Anfang der Datei.
