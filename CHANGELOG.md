...
- **Textverbesserungs-Stufe „Prompt“** (erweiterte Option, ab Werk aus). Einstellungen → Erweiterte Optionen → **Stufe „Prompt“ anbieten** schaltet eine fünfte Stufe in Tastatur und Einstellungen frei. Sie formt ein Diktat zu einem Prompt für KI-Assistenten wie ChatGPT, Claude oder Gemini: Eine kurze Frage bleibt ein bis drei Sätze, mehrere Vorgaben werden eine Liste, ein großer Auftrag bekommt Abschnitte („Ziel:“, „Hintergrund:“, „Aufgabe:“, „Vorgaben:“, „Format:“). Nichts wird dazuerfunden, Selbstkorrekturen („nee, warte …“) werden aufgelöst, die Sprache bleibt. Beantwortet das Modell die diktierte Bitte, statt sie umzuformulieren, kommt der Rohtext mit Hinweis — nie das Gedicht, um das du gebeten hast. Die Gliederung bleibt auch mit „Automatische Absätze“ aus erhalten.
